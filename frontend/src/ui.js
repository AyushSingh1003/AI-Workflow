        ...
        <div className="canvas-shell" ref={reactFlowWrapper}>
            {nodes.length === 0 && (
                <div className="canvas-empty-state">
                    <strong>Build your workflow here</strong>
                    <span>Click or drag nodes from the toolbar above, then connect their handles.</span>
                </div>
            )}
            <ReactFlow
                nodes={nodes}
                ...
                fitView
            >
                <Background color="#d7deea" gap={gridSize} size={1.4} />
